...
const the_family_plan_2023 = ({ movie }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://123gomovies.vercel.app/#website',
        url: 'https://123gomovies.vercel.app/',
        name: '123 Movies™',
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
      ...
      {
        '@type': 'Person',
        '@id': 'https://123gomovies.vercel.app/author/watchmoviesonline/',
        name: 'Dr Trailer',
        url: 'https://123gomovies.vercel.app/author/watchmoviesonline/',
        image: {
          '@type': 'ImageObject',
        ...
        sameAs: ['https://123gomovies.vercel.app/']
      },
      {
        '@type': 'Article',
        '@id': `/${movie['movie.watch']}#article`,
        headline: `Watch ${movie.name} | 123 Movies™`,
        datePublished: '2024-01-13T13:00:00+00:00',
        dateModified: '2024-01-13T13:13:00+00:00',
        articleSection: 'Movie',
        author: {
          '@id':
            'https://123gomovies.vercel.app/author/watchmoviesonline/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        description: `123 Movies | ${movie.name} for free. Where you can find movies of your interest in full HD quality updated on a daily basis. Watch Now or Download Now to Watch Later!`,
        image: movie.image,
        name: `Watch ${movie.name} | 123 Movies™`,
        isPartOf: {
          '@id': `/${movie['movie.watch']}#webpage`
        },
        inLanguage: 'en-US',
  ...
  const ldJsonData = JSON.stringify({
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://123gomovies.vercel.app/og_image.jpg'
      }
    },
    additionalProperty: {
      '@type': 'PropertyValue',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch {movie && movie.name} | 123 Movies™</title>
        ...
        <meta
          name='description'
          content='123 Movies™ is a movie streaming site. Where you can find movies of your interest in full HD quality updated on daily basis. Watch Now or Download Now to Watch Later!'
        />
        ...
        <meta
          property='og:image'
          content={`https://123gomovies.vercel.app/wp-content/uploads/2023/06/${
            movie && movie.poster
          }`}
        />
        ...
        <script
          dangerouslySetInnerHTML={{
            ...
            webpushr('setup', { 'key': 'BCdpTvttsj9GBv_Fk9d5O1tZGc25AuLYszh_9GZSVEPaMctdnpuBD-Yqb10-1WKcFpzfvA32tIsDdg8S8XLPRu8' });
          `
          }}
        />
      </Head>
      ...
      >
        <div style={{ maxWidth: '800px', width: '100%', marginBottom: '20px' }}>
          ...
          <ShareButtons
            ...
            image='https://123gomovies.vercel.app/og_image.jpg'
...
export async function getServerSideProps () {
  const res = await fetch('https://123gomovies.vercel.app/movies.json')
