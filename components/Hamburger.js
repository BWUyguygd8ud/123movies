...
export default function Home () {
  ...
  return (
    <div>
      <nav className='w-full bg-[#a0aec0]' style={{ marginTop: '10px' }}>
        <div className='px-4 mx-auto md:flex md:items-center md:justify-between md:px-8'>
          <div className='flex items-center py-3 md:py-5'>
            <div className='flex items-center flex-col'>
              ...
              />
              <p
                className='text-black mt-2 text-center md:text-right'
          ...
          >
            ...
            <div className='md:flex md:items-center text-center'>
              <a href='/'>
                <div
                  className=' block mt-4 md:inline-block md:mt-0 text-white hover:text-gray-900 mr-4 font-bold'
